                ...
                value: function getContent() {
                    ...
                    if (!this.state.data) {
                        return _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(_neosUiI18n2.default, { id: 'Neos.Neos:Main:loading' })
                        );
                    }
...
module.exports = {"warnIcon":"style__warnIcon___1iOiO"};

/***/ }),

/***/ "./src/ReferenceListView.js":
/*!**********************************!*\
  !*** ./src/ReferenceListView.js ***!
  \**********************************/
/*! no static exports found */
...
var ReferenceListView = (_dec = (0, _index2.default)(), _dec(_class = (_temp = _class2 = function (_PureComponent) {
    _inherits(ReferenceListView, _PureComponent);

    function ReferenceListView() {
        _classCallCheck(this, ReferenceListView);

        return _possibleConstructorReturn(this, (ReferenceListView.__proto__ || Object.getPrototypeOf(ReferenceListView)).apply(this, arguments));
    }

    _createClass(ReferenceListView, [{
        key: 'getRows',
        value: function getRows() {
            ...
            var collectionPath = options.collection;
            if (!data || !collectionPath) {
                return [];
            }
            var collection = (0, _plowJs.$get)(collectionPath, data);
            var columns = options.columns;

            return collection.map(function (row) {
                return columns.map(function (column) {
                    var rowValue = {
                        value: (0, _plowJs.$get)(column.data, row),
                        link: (0, _plowJs.$get)(column.link, row),
                    ...
                    rows.map(function (row, key) {
                        return _react2.default.createElement(
                            ...
                            row.map(function (column, key) {
                                return _react2.default.createElement(
                                    'td',
                                    { key: key, className: _style2.default.column },
                                    column.icon && _react2.default.createElement(_reactUiComponents.Icon, { className: _style2.default.icon, icon: column.icon }),
                                    column.link ? _react2.default.createElement(
                                        'a',
                                        { href: column.link, target: '_blank' },
                                        column.value,
                                        column.suffix
                                    ) : _react2.default.createElement(
                                        'span',
...
exports.default = ReferenceListView;
...
// extracted by mini-css-extract-plugin
module.exports = {"widget":"style__widget___2Hy30","header":"style__header___14NUp","body":"style__body___2Ti5z","label":"style__label___1c1xz","subtitle":"style__subtitle___1UmAS"};
...
var _ReferenceListView = __webpack_require__(/*! ./ReferenceListView */ "./src/ReferenceListView.js");

var _ReferenceListView2 = _interopRequireDefault(_ReferenceListView);
...
(0, _neosUiExtensibility2.default)('Shel.ReferenceList:ReferenceListView', {}, function (globalRegistry) {
    ...
    viewsRegistry.set('Shel.ReferenceList/Inspector/Views/ReferenceListView', {
        component: _ReferenceListView2.default
    });
});
...
// extracted by mini-css-extract-plugin
module.exports = {"table":"style__table___39DpF","column":"style__column___318-X","icon":"style__icon___2naL5"};
